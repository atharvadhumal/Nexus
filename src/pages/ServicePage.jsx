  ...
  return (
    <div itemScope itemType="https://schema.org/Service">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <p itemProp="description" className="text-base sm:text-lg md:text-xl text-white leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {servicesData.services.map((service, index) => (
            <div
              ...
              className="bg-white rounded-lg shadow-lg overflow-hidden h-full transform transition-transform duration-300 hover:scale-105"
            >
              <div className="p-4 sm:p-6">
                <h3 itemProp="name" className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">
                  {service.title}
                </h3>
                <p itemProp="description" className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
                  {service.content}
                </p>
                {service.features && (
      ...
      <div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          ...
          <p itemProp="additionalType" className="text-base sm:text-lg md:text-xl text-white leading-relaxed w-full">
          At Nexus Engineering, we provide comprehensive detailed engineering design services for industrial sectors, including oil & gas, 
          petrochemicals, power generation, and process plants. Our expert team ensures your project progresses smoothly from conceptual design to 
          construction, delivering reliable, cost-effective, and optimized solutions that meet the highest industry standards.
          </p>
          <hr className="border-white my-4 sm:my-6" />
        </div>
      </div>
